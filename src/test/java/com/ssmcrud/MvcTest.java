...
@WebAppConfiguration //加上这个注解才能自动注入webApplicationContext
//@WebAppConfiguration
...
public class MvcTest {
    ...
    @Test
    public void pageText() throws Exception {
        ...
        //modle在域中保存了peminfo，通过mock模仿请求拿到域中的信息
